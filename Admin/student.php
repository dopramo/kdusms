...
<?php  
	if (isset($_POST['btn_save'])) {
		...
		$matric_complition_date = isset($_POST["matric_complition_date"]) ? $_POST["matric_complition_date"] : "";
		$matric_awarded_date = isset($_POST["matric_awarded_date"]) ? $_POST["matric_awarded_date"] : "";
		$fa_complition_date = isset($_POST["fa_complition_date"]) ? $_POST["fa_complition_date"] : "";
		$fa_awarded_date = isset($_POST["fa_awarded_date"]) ? $_POST["fa_awarded_date"] : "";
		$ba_complition_date = isset($_POST["ba_complition_date"]) ? $_POST["ba_complition_date"] : "";
		$ba_awarded_date = isset($_POST["ba_awarded_date"]) ? $_POST["ba_awarded_date"] : "";
		...
		$query = "INSERT INTO student_info (roll_no, first_name, middle_name, last_name, father_name, email, mobile_no, course_code, session, profile_image, dob, gender, permanent_address, current_address, place_of_birth, matric_complition_date, matric_awarded_date, fa_complition_date, fa_awarded_date, ba_complition_date, ba_awarded_date) VALUES ('$roll_no', '$first_name', '$middle_name', '$last_name', '$father_name', '$email', '$mobile_no', '$course_code', '$session', '$profile_image', '$dob', '$gender', '$permanent_address', '$current_address', '$place_of_birth', '$matric_complition_date', '$matric_awarded_date', '$fa_complition_date', '$fa_awarded_date', '$ba_complition_date', '$ba_awarded_date')";
							        ...
							        <form action="student.php" method="POST" enctype="multipart/form-data">
										<div class="row mt-3">
								  		...
								  		<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        <label for="exampleInputEmail1">OLevel Complition Date: </label>
											        <input type="date" name="matric_complition_date" class="form-control">
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">OLevel Certificate:</label>
								  		...
								  		<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        <label for="exampleInputEmail1">ALevel Complition Date: </label>
											        <input type="date" name="fa_complition_date" class="form-control">
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Upload ALevel Certificate:</label>
